...
# # # The following lines define key bindings for navigation and editing.
# # # '^[^[[D': move cursor backward by one word
# # # '^[^[[C': move cursor forward by one word
# # # '^[[5D': move cursor to the beginning of the line
# # # '^[[5C': move cursor to the end of the line
# # # '^[[3~': delete character under the cursor
...
# ----------------------------------------------------------------------------
# Shift-tab selects previous result
