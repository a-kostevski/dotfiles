# Aliases. Mirrors zsh/rc.d/60-aliases.zsh.
...
source "$BDOTDIR/lib/docker.bash"
...
# Note: no manpath entry here — it would shadow manpath(1); no fpath in bash
alias path='echo "$PATH" | tr ":" "\n"'
alias infopath='echo "$INFOPATH" | tr ":" "\n"'
...
alias reload='[[ $SHLVL -eq 1 ]] && exec bash || echo "Warning: Not reloading in subshell (level $SHLVL)"'

# --- Profiling ---
alias bashtime='for i in {1..10}; do time bash -i -c exit; done'
