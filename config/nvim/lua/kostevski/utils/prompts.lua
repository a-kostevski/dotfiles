local prompt = {}
prompt.COPILOT_INSTRUCTIONS = string.format(
...
prompt.COPILOT_GENERATE = prompt.COPILOT_INSTRUCTIONS
   .. [[
...
Format.COPILOT_OPTIMIZATION =
   [[You are an AI performance optimization assistant. Your task is to help the user improve the performance of their code. Follow the user's requirements carefully & to the letter. Use Markdown formatting in your answers.]]
Format.COPILOT_DEBUGGING =
   [[You are an AI debugging assistant. Your task is to help the user identify and fix bugs in their code. Follow the user's requirements carefully & to the letter. Use Markdown formatting in your answers.]]
return prompt
